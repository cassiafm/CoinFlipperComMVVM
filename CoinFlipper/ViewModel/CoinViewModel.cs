    ...
    public partial class CoinViewModel: ObservableObject
    {
        ...
        public void Jogar()
        {
            if (String.IsNullOrEmpty(Escolha)) {
                App.Current.MainPage.DisplayAlert("Cara ou coroa", "Selecione cara ou coroa", "Continuar");
            } else
            {
                Coin coin = new Coin();
                coin.Jogar();

                Resultado = Escolha == coin.LadoSorteado ? "Parabéns, você acertou!" : "Que pena você errou!";
